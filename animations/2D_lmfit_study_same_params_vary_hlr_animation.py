# -*- coding: utf-8 -*-
"""
Created on Thu Jul 24 14:57:04 2014
...
a = ax1.imshow(im,interpolation='none',origin='lower',vmax=im.max()/2,vmin=im.min()/2)
...
b = ax2.imshow(best_fit,origin='lower',vmax=im.max()/2,vmin=im.min()/2)
...
text = ax4.text(0,-1.5,'$HLR_b$: %.2f arcsecond'%(HLR_b),fontsize=18)
