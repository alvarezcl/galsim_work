# -*- coding: utf-8 -*-
"""
Created on Sun Jul 27 15:12:57 2014
...
def run_2_galaxy_vary_distance(flux_a,HLR_a,e1_a,e2_a,x0_a,y0_a,
    ...
    im = im_1 + im_2
    im.addNoise(galsim.GaussianNoise(sigma=1))
...
plt.title('Residual of $e_1$ vs Separation',fontsize=fonts)
plt.ylabel('$Residual$',fontsize=fonts)
p1 = plt.plot(sep,resid[:,col],c='b')
p2 = plt.plot(sep,resid[:,colp],c='g')
p1 = plt.scatter(sep,resid[:,col],c='b',marker='o')
p2 = plt.scatter(sep,resid[:,colp],c='g',marker='x')
...
plt.title('Residual of $e_2$ vs Separation',fontsize=fonts)
...
plt.title('Residual of $Flux$ vs Separation',fontsize=fonts)
plt.ylabel('$Residual$',fontsize=fonts)
p1 = plt.plot(sep,resid[:,col],c='b')
p2 = plt.plot(sep,resid[:,colp],c='g')
p1 = plt.scatter(sep,resid[:,col],c='b',marker='o')
...
plt.title('Residual of $HLR$ vs Separation',fontsize=fonts)
plt.xlabel('$Separation\/(Arcsec)$ ',fontsize=fonts)
plt.ylabel('$Residual$',fontsize=fonts)
p1 = plt.plot(sep,resid[:,col],c='b')
p2 = plt.plot(sep,resid[:,colp],c='g')
...
col = col - 1
colp = col + 6
ax1 = fig3.add_subplot(gs[:4,0])    
plt.title('Residual of $x0$ vs Separation',fontsize=fonts)
plt.ylabel('$Residual$',fontsize=fonts)
p1 = plt.plot(sep,resid[:,col],c='b')
p2 = plt.plot(sep,resid[:,colp],c='g')
p1 = plt.scatter(sep,resid[:,col],c='b',marker='o')
...
col = col - 1
colp = col + 6
ax2 = fig3.add_subplot(gs[5:,0])
plt.title('Residual of $y0$ vs Separation',fontsize=fonts)
plt.xlabel('$Separation\/(Arcsec)$ ',fontsize=fonts)
plt.ylabel('$Residual$',fontsize=fonts)
p1 = plt.plot(sep,resid[:,col],c='b')
p2 = plt.plot(sep,resid[:,colp],c='g')
